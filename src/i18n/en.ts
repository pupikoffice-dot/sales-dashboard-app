export const messages = {
  ...
  'nav.opsDeliveries': 'Deliveries',
  'ops.deliveries.title': 'Deliveries',
  'ops.deliveries.subtitle': 'Cartons and pallets delivered per month — last {months} months',
  'ops.cartons': 'Cartons',
  'ops.pallets': 'Pallets',
  'ops.mtd': 'MTD',
  'ops.cartonsPerMonth': 'Cartons delivered per month',
  'ops.palletsPerMonth': 'Pallets delivered per month',
  'ops.total': 'Total',
  'ops.avgPerMonth': 'Avg / month',
  'ops.avgHint': 'Average of full months with data (current month excluded)',
  'ops.trend': 'Trend',
  'ops.trendHint': 'Linear trend over full months with data (current month excluded)',
  'ops.perMonth': '/ month',
  'ops.agent': 'Agent',
  'ops.client': 'Client',
  'ops.addBox': 'Add client / agent charts',
  'ops.removeBox': 'Remove this box',
  ...
  'ops.noData': 'No delivery data available.',
  'ops.loadError': 'Could not load delivery data.',
  ...
  'sm.cube.yearNetSales': 'Sales {year} — report 891',
  'sm.cube.yearNetSalesHint': 'Report 891 net sales for this agent window',
  'sm.cube.yearNetSalesTotal': 'Year to date {year}',
  'sm.cube.yearNetSalesAvg': 'Avg / mo',
  ...
  'sm.openOrders.agentHint': 'All open orders for this agent by cash. Click a row to see line items.',
  'sm.openOrders.agentTotal': 'Total',
  'sm.returns.agentHint': 'All return items for this agent this month, sorted by cash.',
  ...
  'bi.tsometBudget.totalRow': 'Total',
  'bi.tsometBudget.totalOpenBudget': 'Total open budget',
  ...
  'oversite.deliveryDocsCount': '{count} delivery notes this month — tap one for its items',
  'oversite.deliveryDocLines': 'Lines',
  'oversite.deliveryDocBack': '← All delivery notes',
  'oversite.deliveryDocTitle': 'Delivery note {doc}',
