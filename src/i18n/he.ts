...
export const messages: Record<keyof typeof en, string> = {
  ...
  'nav.opsDeliveries': 'משלוחים',
  'ops.deliveries.title': 'משלוחים',
  'ops.deliveries.subtitle': 'קרטונים ומשטחים שנשלחו בכל חודש — {months} החודשים האחרונים',
  'ops.cartons': 'קרטונים',
  'ops.pallets': 'משטחים',
  'ops.mtd': 'מתחילת החודש',
  'ops.cartonsPerMonth': 'קרטונים שנשלחו בכל חודש',
  'ops.palletsPerMonth': 'משטחים שנשלחו בכל חודש',
  'ops.total': 'סה״כ',
  'ops.avgPerMonth': 'ממוצע לחודש',
  'ops.avgHint': 'ממוצע החודשים המלאים עם נתונים (ללא החודש הנוכחי)',
  'ops.trend': 'מגמה',
  'ops.trendHint': 'מגמה לינארית על החודשים המלאים עם נתונים (ללא החודש הנוכחי)',
  'ops.perMonth': 'לחודש',
  'ops.agent': 'סוכן',
  'ops.client': 'לקוח',
  'ops.addBox': 'הוספת גרפים ללקוח / סוכן',
  'ops.removeBox': 'הסרת התיבה',
  ...
  'ops.noData': 'אין נתוני משלוחים.',
  'ops.loadError': 'לא ניתן לטעון את נתוני המשלוחים.',
  ...
  'sm.cube.yearNetSales': 'מכירות {year} — דוח 891',
  'sm.cube.yearNetSalesHint': 'מכירות נטו מדוח 891 לחלון הסוכן',
  'sm.cube.yearNetSalesTotal': 'מתחילת {year}',
  'sm.cube.yearNetSalesAvg': 'ממוצע / חודש',
  ...
  'sm.openOrders.agentHint': 'כל ההזמנות הפתוחות של הסוכן לפי סכום. לחצו על שורה לפירוט שורות.',
  'sm.openOrders.agentTotal': 'סה״כ',
  'sm.returns.agentHint': 'כל פריטי ההחזרה של הסוכן החודש, ממוינים לפי סכום.',
  ...
  'bi.tsometBudget.totalRow': 'סה״כ',
  'bi.tsometBudget.totalOpenBudget': 'סה״כ תקציב פתוח',
  ...
  'oversite.deliveryDocNumber': 'מס׳ תעודה',
  'oversite.deliveryDocsCount': '{count} תעודות משלוח החודש — לחצו על תעודה לפירוט הפריטים',
  'oversite.deliveryDocLines': 'שורות',
  'oversite.deliveryDocBack': '→ כל תעודות המשלוח',
  'oversite.deliveryDocTitle': 'תעודת משלוח {doc}',
